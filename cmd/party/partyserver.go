...
func main() {
	...
	pwd, _ := os.Getwd()
	partyservice.StartPartyServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
