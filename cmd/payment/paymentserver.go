...
import (
	...
	paymentservices "github.com/cloudfresco/sc-ubl/internal/services/paymentservices"
...
func main() {
	...
	log := config.SetUpLogging(logOpt.PaymentPath)
	...
	pwd, _ := os.Getwd()
	paymentservices.StartPaymentServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
