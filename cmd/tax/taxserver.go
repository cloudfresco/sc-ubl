...
func main() {
	...
	log := config.SetUpLogging(logOpt.TaxPath)
	...
	pwd, _ := os.Getwd()
	taxservices.StartTaxServer(log, false, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
}
