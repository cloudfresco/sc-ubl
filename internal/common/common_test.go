...
func TestParseURL(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{
				urlString: `/v2.3/categories/?cursor=&limit=20`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/create/`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/chdcreate/`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/topcats`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0/chdn`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/categories/b8399c93-3ebd-48ed-8e20-067ab81067eb/getparent`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/topics/69280d16-02d5-4908-b59a-923b4e86f7bd`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/topics/topicbyname`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/messages/create`,
			},
		...
		{
			args: args{
				urlString: `/v2.3/messages/3ea3c22d-2949-4afa-aae4-2bac1e15359b`,
			},
...
func TestGetPathQueryString(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{
				s: `/v2.3/categories/?cursor=&limit=20`,
			},
			want:    "/v2.3/categories/",
			want1:   url.Values{"cursor": {""}, "limit": {"20"}},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/create/`,
			},
			want:    "/v2.3/categories/create/",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0`,
			},
			want:    "/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/chdcreate/`,
			},
			want:    "/v2.3/categories/chdcreate/",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/topcats`,
			},
			want:    "/v2.3/categories/topcats",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0/chdn`,
			},
			want:    "/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0/chdn",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/categories/b8399c93-3ebd-48ed-8e20-067ab81067eb/getparent`,
			},
			want:    "/v2.3/categories/b8399c93-3ebd-48ed-8e20-067ab81067eb/getparent",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/topics/create/`,
			},
			want:    "/v2.3/topics/create/",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/topics/69280d16-02d5-4908-b59a-923b4e86f7bd`,
			},
			want:    "/v2.3/topics/69280d16-02d5-4908-b59a-923b4e86f7bd",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/topics/topicbyname`,
			},
			want:    "/v2.3/topics/topicbyname",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/messages/create/`,
			},
			want:    "/v2.3/messages/create/",
			want1:   url.Values{},
			wantErr: false,
		},
		{
			args: args{
				s: `/v2.3/messages/3ea3c22d-2949-4afa-aae4-2bac1e15359b`,
			},
			want:    "/v2.3/messages/3ea3c22d-2949-4afa-aae4-2bac1e15359b",
			want1:   url.Values{},
			wantErr: false,
		},
	}
...
func TestGetPathParts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			args: args{
				url: "/v2.3/categories/create/",
			},
			want: []string{"v0.1", "categories", "create"},
		},
		{
			args: args{
				url: "/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0",
			},
			want: []string{"v0.1", "categories", "2d656454-8191-4193-94e1-4f27ed37d6b0"},
		},
		{
			args: args{
				url: "/v2.3/categories/chdcreate/",
			},
			want: []string{"v0.1", "categories", "chdcreate"},
		},
		{
			args: args{
				url: "/v2.3/categories/topcats",
			},
			want: []string{"v0.1", "categories", "topcats"},
		},
		{
			args: args{
				url: "/v2.3/categories/2d656454-8191-4193-94e1-4f27ed37d6b0/chdn",
			},
			want: []string{"v0.1", "categories", "2d656454-8191-4193-94e1-4f27ed37d6b0", "chdn"},
		},
		{
			args: args{
				url: "/v2.3/categories/b8399c93-3ebd-48ed-8e20-067ab81067eb/getparent",
			},
			want: []string{"v0.1", "categories", "b8399c93-3ebd-48ed-8e20-067ab81067eb", "getparent"},
		},
		{
			args: args{
				url: "/v2.3/topics/create/",
			},
			want: []string{"v0.1", "topics", "create"},
		},
		{
			args: args{
				url: "/v2.3/topics/69280d16-02d5-4908-b59a-923b4e86f7bd",
			},
			want: []string{"v0.1", "topics", "69280d16-02d5-4908-b59a-923b4e86f7bd"},
		},
		{
			args: args{
				url: "/v2.3/topics/topicbyname/",
			},
			want: []string{"v0.1", "topics", "topicbyname"},
		},
		{
			args: args{
				url: "/v2.3/messages/create/",
			},
			want: []string{"v0.1", "messages", "create"},
		},
		{
			args: args{
				url: "/v2.3/messages/3ea3c22d-2949-4afa-aae4-2bac1e15359b",
			},
			want: []string{"v0.1", "messages", "3ea3c22d-2949-4afa-aae4-2bac1e15359b"},
		},
	}
