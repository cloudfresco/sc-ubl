...
import (
	...
	logisticsservices "github.com/cloudfresco/sc-ubl/internal/services/logisticsservices"
	partyservices "github.com/cloudfresco/sc-ubl/internal/services/partyservices"

	logisticsworkers "github.com/cloudfresco/sc-ubl/internal/workers/logisticsworkers"
...
func TestMain(m *testing.M) {
	...
	pwd, _ := os.Getwd()
	go logisticsservices.StartLogisticsServer(logLogistics, true, pwd, dbOpt, redisOpt, mailerOpt, grpcServerOpt, jwtOpt, oauthOpt, userOpt, uptraceOpt, dbService, redisService, mailerService)
	...
	go logisticsworkers.StartLogisticsWorker(log, true, pwd, grpcServerOpt, configFilePath)
