...
func TestGetUsers(t *testing.T) {
	...
	req, err := http.NewRequest("GET", backendServerAddr+"/v2.3/users", nil)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetUser(t *testing.T) {
	...
	req, err := http.NewRequest("GET", backendServerAddr+"/v2.3/users/auth0|673c75d516e8adb9e6ffc892", nil)
	if err != nil {
		t.Error(err)
		return
	}
...
func TestGetUserByEmail(t *testing.T) {
	...
	req, err := http.NewRequest("POST", backendServerAddr+"/v2.3/users/getuserbyemail", bytes.NewBuffer(data))
	if err != nil {
		t.Error(err)
		return
	}
...
func TestChangePassword(t *testing.T) {
	...
	req, err := http.NewRequest("POST", backendServerAddr+"/v2.3/users/change-password", bytes.NewBuffer(data))
	if err != nil {
		t.Error(err)
		return
	}
