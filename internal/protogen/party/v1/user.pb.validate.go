...
// Validate checks the field values on AddAPIPermissionRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AddAPIPermissionRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AddAPIPermissionRequestMultiError, or nil if none found.
func (m *AddAPIPermissionRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AddAPIPermissionRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetPermissions() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, AddAPIPermissionRequestValidationError{
			...
			if err := v.Validate(); err != nil {
				return AddAPIPermissionRequestValidationError{
					field:  fmt.Sprintf("Permissions[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return AddAPIPermissionRequestMultiError(errors)
	}

	return nil
}

// AddAPIPermissionRequestMultiError is an error wrapping multiple validation
// errors returned by AddAPIPermissionRequest.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m AddAPIPermissionRequestMultiError) AllErrors() []error { return m }

// AddAPIPermissionRequestValidationError is the validation error returned by
// AddAPIPermissionRequest.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AddAPIPermissionRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddAPIPermissionRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddAPIPermissionRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddAPIPermissionRequestValidationError) Key() bool { return e.key }
...
func (e AddAPIPermissionRequestValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sAddAPIPermissionRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddAPIPermissionRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddAPIPermissionRequestValidationError{}

// Validate checks the field values on AddAPIPermissionResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on AddAPIPermissionResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AddAPIPermissionResponseMultiError, or nil if none found.
func (m *AddAPIPermissionResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *AddAPIPermissionResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return AddAPIPermissionResponseMultiError(errors)
	}

	return nil
}

// AddAPIPermissionResponseMultiError is an error wrapping multiple validation
// errors returned by AddAPIPermissionResponse.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m AddAPIPermissionResponseMultiError) AllErrors() []error { return m }

// AddAPIPermissionResponseValidationError is the validation error returned by
// AddAPIPermissionResponse.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e AddAPIPermissionResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AddAPIPermissionResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AddAPIPermissionResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AddAPIPermissionResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AddAPIPermissionResponseValidationError) ErrorName() string {
	return "AddAPIPermissionResponseValidationError"
}
...
func (e AddAPIPermissionResponseValidationError) Error() string {
	...
	return fmt.Sprintf(
		"invalid %sAddAPIPermissionResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AddAPIPermissionResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AddAPIPermissionResponseValidationError{}
