...
// Validate checks the field values on GetTaxCategoryRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTaxCategoryRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTaxCategoryRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaxCategoryRequestMultiError, or nil if none found.
func (m *GetTaxCategoryRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaxCategoryRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetTaxCategoryRequestValidationError{
					field:  "GetRequest",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetTaxCategoryRequestValidationError{
				field:  "GetRequest",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetTaxCategoryRequestMultiError(errors)
	}

	return nil
}

// GetTaxCategoryRequestMultiError is an error wrapping multiple validation
// errors returned by GetTaxCategoryRequest.ValidateAll() if the designated
// constraints aren't met.
type GetTaxCategoryRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaxCategoryRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaxCategoryRequestMultiError) AllErrors() []error { return m }

// GetTaxCategoryRequestValidationError is the validation error returned by
// GetTaxCategoryRequest.Validate if the designated constraints aren't met.
type GetTaxCategoryRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTaxCategoryRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaxCategoryRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaxCategoryRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaxCategoryRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaxCategoryRequestValidationError) ErrorName() string {
	return "GetTaxCategoryRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaxCategoryRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaxCategoryRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaxCategoryRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaxCategoryRequestValidationError{}

// Validate checks the field values on GetTaxCategoryResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTaxCategoryResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTaxCategoryResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaxCategoryResponseMultiError, or nil if none found.
func (m *GetTaxCategoryResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaxCategoryResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetTaxCategoryResponseValidationError{
					field:  "TaxCategory",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetTaxCategoryResponseValidationError{
				field:  "TaxCategory",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetTaxCategoryResponseMultiError(errors)
	}

	return nil
}

// GetTaxCategoryResponseMultiError is an error wrapping multiple validation
// errors returned by GetTaxCategoryResponse.ValidateAll() if the designated
// constraints aren't met.
type GetTaxCategoryResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaxCategoryResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaxCategoryResponseMultiError) AllErrors() []error { return m }

// GetTaxCategoryResponseValidationError is the validation error returned by
// GetTaxCategoryResponse.Validate if the designated constraints aren't met.
type GetTaxCategoryResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTaxCategoryResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaxCategoryResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaxCategoryResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaxCategoryResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaxCategoryResponseValidationError) ErrorName() string {
	return "GetTaxCategoryResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaxCategoryResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaxCategoryResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaxCategoryResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaxCategoryResponseValidationError{}
...
// Validate checks the field values on GetTaxTotalRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTaxTotalRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTaxTotalRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaxTotalRequestMultiError, or nil if none found.
func (m *GetTaxTotalRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaxTotalRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetTaxTotalRequestValidationError{
					field:  "GetRequest",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetTaxTotalRequestValidationError{
				field:  "GetRequest",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetTaxTotalRequestMultiError(errors)
	}

	return nil
}

// GetTaxTotalRequestMultiError is an error wrapping multiple validation errors
// returned by GetTaxTotalRequest.ValidateAll() if the designated constraints
// aren't met.
type GetTaxTotalRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaxTotalRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaxTotalRequestMultiError) AllErrors() []error { return m }

// GetTaxTotalRequestValidationError is the validation error returned by
// GetTaxTotalRequest.Validate if the designated constraints aren't met.
type GetTaxTotalRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTaxTotalRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaxTotalRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaxTotalRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaxTotalRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaxTotalRequestValidationError) ErrorName() string {
	return "GetTaxTotalRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaxTotalRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaxTotalRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaxTotalRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaxTotalRequestValidationError{}

// Validate checks the field values on GetTaxTotalResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTaxTotalResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTaxTotalResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTaxTotalResponseMultiError, or nil if none found.
func (m *GetTaxTotalResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTaxTotalResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetTaxTotalResponseValidationError{
					field:  "TaxTotal",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetTaxTotalResponseValidationError{
				field:  "TaxTotal",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetTaxTotalResponseMultiError(errors)
	}

	return nil
}

// GetTaxTotalResponseMultiError is an error wrapping multiple validation
// errors returned by GetTaxTotalResponse.ValidateAll() if the designated
// constraints aren't met.
type GetTaxTotalResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTaxTotalResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTaxTotalResponseMultiError) AllErrors() []error { return m }

// GetTaxTotalResponseValidationError is the validation error returned by
// GetTaxTotalResponse.Validate if the designated constraints aren't met.
type GetTaxTotalResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTaxTotalResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTaxTotalResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTaxTotalResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTaxTotalResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTaxTotalResponseValidationError) ErrorName() string {
	return "GetTaxTotalResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetTaxTotalResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTaxTotalResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTaxTotalResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTaxTotalResponseValidationError{}
