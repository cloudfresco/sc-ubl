...
const (
	...
	TaxService_GetTaxCategory_FullMethodName              = "/tax.v1.TaxService/GetTaxCategory"
...
type TaxServiceClient interface {
	...
	GetTaxCategory(ctx context.Context, in *GetTaxCategoryRequest, opts ...grpc.CallOption) (*GetTaxCategoryResponse, error)
...
func (c *taxServiceClient) GetTaxCategory(ctx context.Context, in *GetTaxCategoryRequest, opts ...grpc.CallOption) (*GetTaxCategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTaxCategoryResponse)
	err := c.cc.Invoke(ctx, TaxService_GetTaxCategory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaxServiceServer interface {
	...
	GetTaxCategory(context.Context, *GetTaxCategoryRequest) (*GetTaxCategoryResponse, error)
...
func (UnimplementedTaxServiceServer) GetTaxCategory(context.Context, *GetTaxCategoryRequest) (*GetTaxCategoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTaxCategory not implemented")
}
...
func _TaxService_GetTaxCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTaxCategoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaxServiceServer).GetTaxCategory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaxService_GetTaxCategory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaxServiceServer).GetTaxCategory(ctx, req.(*GetTaxCategoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaxService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetTaxCategory",
			Handler:    _TaxService_GetTaxCategory_Handler,
		},
		{
