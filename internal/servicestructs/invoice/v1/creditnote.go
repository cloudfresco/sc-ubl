...
// CreditNoteHeader - struct CreditNoteHeader
type CreditNoteHeader struct {
	*invoiceproto.CreditNoteHeaderD
	*CreditNoteHeaderT
	*commonproto.CrUpdUser
	*commonstruct.CrUpdTime
}

// CreditNoteHeaderT - struct CreditNoteHeaderT
...
// CreditNoteLine - struct CreditNoteLine
type CreditNoteLine struct {
	*invoiceproto.CreditNoteLineD
	*CreditNoteLineT
	*commonproto.CrUpdUser
	*commonstruct.CrUpdTime
}

// CreditNoteLineT - struct CreditNoteLineT
